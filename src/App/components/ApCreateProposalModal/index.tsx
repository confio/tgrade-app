...
const ProposalProposeArbiters = lazy(() => import("./components/ProposalProposeArbiters"));
...
export enum ProposalType {
  ProposeArbiters = "propose-arbiters",
  OpenText = "open-text",
}

export const proposalLabels = {
  [ProposalType.ProposeArbiters]: "Propose arbiters",
...
export default function ApCreateProposalModal({
  isModalOpen,
  closeModal,
  refreshProposals,
    ...
    >
      {txResult ? (
        ...
        <Stack gap="s1">
          ...
          ) : proposalStep.type === ProposalType.ProposeArbiters ? (
