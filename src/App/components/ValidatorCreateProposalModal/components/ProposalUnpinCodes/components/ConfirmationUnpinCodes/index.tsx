...
interface ConfirmationUnpinCodesProps {
...
export default function ConfirmationUnpinCodes({
  codeIds,
  comment,
  isSubmitting,
  goBack,
  submitForm,
}: ConfirmationUnpinCodesProps): JSX.Element {
  ...
  return (
    <>
      <CodesStack gap="s-3">
        <Text>Code IDs to be unpinned</Text>
