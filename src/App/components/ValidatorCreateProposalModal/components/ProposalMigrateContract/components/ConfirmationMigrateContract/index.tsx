...
interface ConfirmationMigrateContractProps {
...
export default function ConfirmationMigrateContract({
  contract,
  codeId,
  migrateMsg,
  comment,
  ...
  goBack,
  submitForm,
}: ConfirmationMigrateContractProps): JSX.Element {
