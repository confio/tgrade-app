...
describe("Trusted Circle", () => {
  it(
    "Create a Trusted circle with one voting member (you)",
    async () => {
  ...
  it(
    "Create and execute TC proposal for adding voting members",
    async () => {
      const wallet = await DirectSecp256k1HdWallet.fromMnemonic(mnemonic, {
        hdPaths: [makeCosmoshubPath(0)],
        prefix: config.addressPrefix,
  ...
  it(
    "Create and execute TC proposal for adding non voting members",
    async () => {
      const wallet = await DirectSecp256k1HdWallet.fromMnemonic(mnemonic, {
        hdPaths: [makeCosmoshubPath(0)],
        prefix: config.addressPrefix,
  ...
  it(
    "Create and execute TC proposal for editing trusted circle",
    async () => {
      const wallet = await DirectSecp256k1HdWallet.fromMnemonic(mnemonic, {
        hdPaths: [makeCosmoshubPath(0)],
        prefix: config.addressPrefix,
  ...
  it(
    "Create and execute TC proposal for removing non voting participants",
    async () => {
      const wallet = await DirectSecp256k1HdWallet.fromMnemonic(mnemonic, {
        hdPaths: [makeCosmoshubPath(0)],
        prefix: config.addressPrefix,
  ...
  it(
    "Create and execute TC proposal for punishing voting participant (burn_escrow)",
    async () => {
      const wallet = await DirectSecp256k1HdWallet.fromMnemonic(mnemonic, {
        hdPaths: [makeCosmoshubPath(0)],
        prefix: config.addressPrefix,
  ...
  it(
    "Create and execute TC proposal for punishing voting participant (distribute_escrow)",
    async () => {
      const wallet = await DirectSecp256k1HdWallet.fromMnemonic(mnemonic, {
        hdPaths: [makeCosmoshubPath(0)],
        prefix: config.addressPrefix,
  ...
  it(
    "Create and execute TC proposal for whitelist pair",
    async () => {
      const wallet = await DirectSecp256k1HdWallet.fromMnemonic(mnemonic, {
        hdPaths: [makeCosmoshubPath(0)],
        prefix: config.addressPrefix,
