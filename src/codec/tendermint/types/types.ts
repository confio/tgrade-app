...
export const Header = {
  ...
  toJSON(message: Header): unknown {
    ...
    message.time !== undefined &&
      (obj.time = message.time !== undefined ? fromTimestamp(message.time).toISOString() : null);
    message.lastBlockId !== undefined &&
...
export const Vote = {
  ...
  toJSON(message: Vote): unknown {
    ...
    message.timestamp !== undefined &&
      (obj.timestamp =
        message.timestamp !== undefined ? fromTimestamp(message.timestamp).toISOString() : null);
