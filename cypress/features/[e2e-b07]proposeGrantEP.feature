Feature: Create, vote, and execute "Grant Engagement Points" proposal
  Background:
  ...
  Scenario: Propose Grant EP
    # Create proposal
    * I click on the "Add proposal" button
    * I see the "New proposal" modal and select "Grant Engagement Points"
    * I click on "Next"
    * I enter a random address on the "Member to grant Engagements Points to" field
    * I enter a number on the "Number of Engagement Points" field
