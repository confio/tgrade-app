Feature: Create, vote, and execute "Update consensus block parameters" proposal
  Background:
  ...
  Scenario: Propose Update consensus block parameters
    # Create proposal
    * I click on the "Add proposal" button
    * I see the "New proposal" modal and select "Update consensus block parameters"
    * I click on "Next"
    * I enter a number on the "Maximum bytes" field
    * I enter a number on the "Maximum gas" field
