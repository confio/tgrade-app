Feature: Create, vote, and execute "Punish validator" proposal with jailing forever
  Background:
  ...
  Scenario: Propose punish validator forever
    # Create proposal
    ...
    * I click on the "Jail Forever" checkbox
