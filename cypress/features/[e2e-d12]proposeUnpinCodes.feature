Feature: Create, vote, and execute "Unpin codes" proposal
  Background:
  ...
  Scenario: Propose Unpin codes
    # Create proposal
    * I click on the "Add proposal" button
    * I see the "New proposal" modal and select "Unpin codes"
    * I click on "Next"
    * I enter a list of numbers on the "Code IDs to be unpinned" field
