Feature: Create, vote, and execute "Update consensus evidence parameters" proposal
  Background:
  ...
  Scenario: Propose Update consensus evidence parameters
    # Create proposal
    * I click on the "Add proposal" button
    * I see the "New proposal" modal and select "Update consensus evidence parameters"
    * I click on "Next"
    * I enter a number on the "Maximum age of evidence (blocks)" field
    * I enter a number on the "Maximum age of evidence (seconds)" field
    * I enter a number on the "Maximum bytes" field
