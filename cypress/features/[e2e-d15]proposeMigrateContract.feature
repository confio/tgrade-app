Feature: Create, vote, and execute "Migrate contract" proposal
  Background:
  ...
  Scenario: Propose Migrate contract
    # Create proposal
    * I click on the "Add proposal" button
    * I see the "New proposal" modal and select "Migrate contract"
    * I click on "Next"
    * I enter a contract address on the "Contract address" field
    * I enter a number on the "Migrate to Code ID" field
    * I enter some text on the "Migrate message" field
