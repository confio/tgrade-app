Feature: Punish Oversight Community members proposal with "distribute_escrow"
  Background:
  ...
  Scenario: Propose punish OC member and distribute
    # Create proposal
    ...
    * I enter some random addresses on the "Distribution list for slashed escrow"
