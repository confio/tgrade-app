Feature: Create, vote, and execute "Pin codes" proposal
  Background:
  ...
  Scenario: Propose Pin codes
    # Create proposal
    * I click on the "Add proposal" button
    * I see the "New proposal" modal and select "Pin codes"
    * I click on "Next"
    * I enter a list of numbers on the "Code IDs to be pinned" field
